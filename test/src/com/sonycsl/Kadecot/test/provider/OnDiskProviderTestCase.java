...
public class OnDiskProviderTestCase extends ProviderTestCase2<OnDiskProvider> {

    private static enum DeviceData {

        Device1("protocol1", "type1", "desc1", 1, "nickname1", "ip1", "bssid1"),
        Device2("protocol2", "type2", "desc2", 1, "nickname2", "ip2", "bssid2");
    ...
    public OnDiskProviderTestCase() {
        super(OnDiskProvider.class, OnDiskProvider.AUTHORITY);
    }

    private OnDiskProvider mProvider;
    ...
    public void testDeviceInsert() {
        for (DeviceData data : DeviceData.values()) {
            ...
            values.put(KadecotCoreStore.Devices.DeviceColumns.IP_ADDR, data.getIpAddr());
            values.put(KadecotCoreStore.Devices.DeviceColumns.BSSID, data.getBssId());
