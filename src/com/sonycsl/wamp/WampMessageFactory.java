...
import com.sonycsl.wamp.message.WampAbortMessageImpl;
import com.sonycsl.wamp.message.WampCallMessageImpl;
import com.sonycsl.wamp.message.WampErrorMessageImpl;
import com.sonycsl.wamp.message.WampEventMessageImpl;
import com.sonycsl.wamp.message.WampGoodbyeMessageImpl;
import com.sonycsl.wamp.message.WampHelloMessageImpl;
import com.sonycsl.wamp.message.WampInvocationMessageImpl;
import com.sonycsl.wamp.message.WampPublishMessageImpl;
import com.sonycsl.wamp.message.WampPublishedMessageImpl;
import com.sonycsl.wamp.message.WampRegisterMessageImpl;
import com.sonycsl.wamp.message.WampRegisteredMessageImpl;
import com.sonycsl.wamp.message.WampResultMessageImpl;
import com.sonycsl.wamp.message.WampSubscribeMessageImpl;
import com.sonycsl.wamp.message.WampSubscribedMessageImpl;
import com.sonycsl.wamp.message.WampUnregisterMessageImpl;
import com.sonycsl.wamp.message.WampUnregisteredMessageImpl;
import com.sonycsl.wamp.message.WampUnsubscribeMessageImpl;
import com.sonycsl.wamp.message.WampUnsubscribedMessageImpl;
import com.sonycsl.wamp.message.WampWelcomeMessageImpl;
import com.sonycsl.wamp.message.WampYieldMessageImpl;
