...
public class ECHONETLiteDeviceAgent extends DeviceObject {

    private final ECHONETLiteDeviceData mData;

    private final ECHONETLiteDeviceGenerator mGenerator;

    public ECHONETLiteDeviceAgent(ECHONETLiteDeviceData data, ECHONETLiteDeviceGenerator gen) {
        mData = data;
        mGenerator = gen;
