...
public class EchoHandler {
	...
	public EchoDeviceData getDeviceData(String nickname) {
		return mEchoDeviceDatabase.getDeviceData(
				DeviceDatabase.getInstance(mContext).getDeviceData(nickname));
	}
	public EchoDeviceData getDeviceData(long deviceId) {
		return mEchoDeviceDatabase.getDeviceData(
				DeviceDatabase.getInstance(mContext).getDeviceData(deviceId));
	}
