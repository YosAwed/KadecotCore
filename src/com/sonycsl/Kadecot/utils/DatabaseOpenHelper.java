...
public class DatabaseOpenHelper extends SQLiteOpenHelper {
	...
	public DatabaseOpenHelper(Context context, String dbName, int version, String tableName, Map<String, String> columns) {
	...
	public void update(String key, String arg, ContentValues values) {
		SQLiteDatabase db = getWritableDatabase();
		db.update(mTableName, values, key + "=?", new String[] { arg });
	}
	...
	public void delete(String key, String arg) {
		...
		SQLiteDatabase db = getWritableDatabase();
		db.delete(mTableName, key + "=?", new String[] { arg });
	}
	...
	public Cursor getCursorByRowId(long rowid) {
		...
		Cursor cursor = db.query(mTableName, mColumnNames, "rowid=?",
	...
	public Cursor getCursor() {
		SQLiteDatabase db = getReadableDatabase();
		Cursor cursor = db.query(mTableName, mColumnNames, null, null, null,
				null, null);
		cursor.moveToFirst();
		return cursor;
	}
	...
	public Cursor getCursor(String key, String arg) {
		SQLiteDatabase db = getReadableDatabase();
		Cursor cursor = db.query(mTableName, mColumnNames, key + "=?",
	...
	public Cursor getCursor(Where where) {
		...
		SQLiteDatabase db = getReadableDatabase();
		Cursor cursor = db.query(mTableName, mColumnNames, where.getClause(),
	...
	public Cursor getCursor(Where where, OrderBy orderBy) {
		...
		if (!where.isValid()) {return null; }
		if (!orderBy.isValid()) { return null; }

		SQLiteDatabase db = getReadableDatabase();
		Cursor cursor = db.query(mTableName, mColumnNames, where.getClause(),
				where.args, null, null, orderBy.getClause());
		cursor.moveToFirst();
		return cursor;
	}
