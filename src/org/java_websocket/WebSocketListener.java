...
public interface WebSocketListener {
    ...
    /**
     * Called after <var>onHandshakeReceived</var> returns <var>true</var>. Indicates that a
     * complete WebSocket connection has been established, and we are ready to send/receive data.
     * 
    ...
    /**
     * Called if an exception worth noting occurred. If an error causes the connection to fail
     * onClose will be called additionally afterwards.
     * 
