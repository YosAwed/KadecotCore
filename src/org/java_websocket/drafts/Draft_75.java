...
public class Draft_75 extends Draft {
    ...
    protected List<Framedata> translateRegularFrame(ByteBuffer buffer) throws InvalidDataException {
        ...
        while (buffer.hasRemaining()) {
            ...
            if (newestByte == START_OF_FRAME) { // Beginning of Frame
                ...
                readingState = false;
            } else if (readingState) { // Regular frame data, add to current frame buffer //TODO
                                       // This code is very expensive and slow
    ...
    public ByteBuffer increaseBuffer(ByteBuffer full) throws LimitExedeedException,
